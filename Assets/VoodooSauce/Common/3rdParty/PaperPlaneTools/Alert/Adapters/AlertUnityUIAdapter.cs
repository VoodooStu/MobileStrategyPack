    ...
    public class AlertUnityUIAdapter : MonoBehaviour, IAlertPlatformAdapter
    {
        ...
        void IAlertPlatformAdapter.Show(Alert alert)
        {
            ...
            if (this.dismissPanel != null) {
                ...
                if (eventTrigger != null) {
                    ...
                    triggers.RemoveAll((EventTrigger.Entry foo) => { return true; });
                    EventTrigger.Entry entry = new EventTrigger.Entry();
                    entry.eventID = EventTriggerType.PointerClick;
                    entry.callback.AddListener((eventData) => { (this as IAlertPlatformAdapter).Dismiss(); });
                    triggers.Add(entry);
                }
            }
        ...
        private void SetButton(Button uiButton, AlertButton alertButton)
        {
            if (uiButton != null) {
                ...
                uiButton.onClick.AddListener(() => { (this as IAlertPlatformAdapter).Dismiss(); });
                if (alertButton != null && alertButton.Handler != null) {
                    uiButton.onClick.AddListener(() => { alertButton.Handler.Invoke(); });
                }
            }
        }
    }
