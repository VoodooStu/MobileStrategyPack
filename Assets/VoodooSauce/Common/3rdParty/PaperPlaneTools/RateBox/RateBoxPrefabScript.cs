namespace PaperPlaneTools
{
    ...
    public class RateBoxPrefabScript : MonoBehaviour
    {
        ...
        */
        ...
        [Tooltip(
            "Check internet connection before prompting a dialog. This makes sense because user won't be able to rate the app without an internet connection.")]
        /// <summary>
