#if UNITY_EDITOR
namespace Voodoo.Sauce.Internal.DebugScreen.CodeStage.AdvancedFPSCounter.Editor
{
	using UI;
	using Labels;
	...
	internal class AFPSCounterEditor: Editor
	{
		...
		private SerializedProperty realtimeFPSFoldout;
		private SerializedProperty fpsRealtime;
		private SerializedProperty fpsMilliseconds;

		private SerializedProperty averageFoldout;
		...
		private SerializedProperty minMaxFoldout;
		...
		private SerializedProperty renderFoldout;
