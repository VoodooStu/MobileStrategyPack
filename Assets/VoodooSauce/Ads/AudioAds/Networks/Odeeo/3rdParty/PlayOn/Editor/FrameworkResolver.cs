...
{
    private const string FRAMEWORK_LOCAL_PATH = "PlayOn/Plugins/IOS";
    ...
    public static void OnPostprocessBuild(BuildTarget buildTarget, string path)
    {
        ...
        string frameworkPath = EditorHelper.GetAssetBasedPath(FRAMEWORK_LOCAL_PATH);

        string sourcePlayOnPath = Path.Combine(frameworkPath, "PlayOnSDK.xcframework");
        string sourceOMPath = Path.Combine(frameworkPath, "OMSDK_Odeeoio.xcframework");
        ...
        string simulatorPlayOnFrameworkPath = "ios-arm64_i386_x86_64-simulator/PlayOnSDK.framework";
...
#endif
        // We comment this line because we already do it in another scripts and it can breaks the iOS build.
