...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
        ...
        /////////////DO NOT REMOVE WHEN UPDATING ADJUST SDK ///////////////////////////
        // this property is added by Voodoo in order to be able to subscribe to session callbacks
        public Action Init;
        // this property is added by Voodoo in order to be able to subscribe to attribution callbacks
        public Action<AdjustAttribution> AttributionChange;
        ////////////////////////////////////////////////////////////////////////////////
        ...
        void Awake()
        {
            ...
            if (!this.startManually)
            {
                ...
                //////////////DO NOT REMOVE WHEN UPDATING ADJUST SDK ///////////////////////////
                adjustConfig.setSessionSuccessDelegate(s => Init?.Invoke());
                adjustConfig.setSessionFailureDelegate(f => Init?.Invoke());
                adjustConfig.setAttributionChangedDelegate(attribution => AttributionChange?.Invoke(attribution));
                //////////////////////////////////////////////////////////////////////////////
