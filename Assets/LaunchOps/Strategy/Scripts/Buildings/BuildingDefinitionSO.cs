...
public class BuildingDefinitionSO : ScriptableObject
{
   ...
   /// </summary>
    ...
    public int MaxLevel => BuildingManager.Instance.GetMaxBuildingLevel(this);
    ...
    public bool IsMaxLevel
    {
        get
        {
            ...
            int maxAllowedLevel = MaxLevel;// BuildingManager.Instance.GetMaxAllowedBuildingLevel(this);
            return Level >= maxAllowedLevel;// BuildingManager.Instance.BuildingGlobalConfig.MaxBuildingLevel;
        }
    ...
    internal bool HasSubBuilding(BuildingDefinitionSO building)
    {
        foreach(var constraint in UpgradeConstraints)
        {
            if(constraint.BuildingDefinition == building)
            {
                return true;
            }
        }
